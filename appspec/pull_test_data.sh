...
for i in 1 2 3 4 5
do
  python3 manage.py pull_twitter_data "election" --batchsize=500
  python3 manage.py pull_twitter_data "us politics" --batchsize=500
  python3 manage.py pull_twitter_data "uk politics" --batchsize=500
  ...
  python3 manage.py process_twitter_data --batchsize=1000
  # Process the stats
